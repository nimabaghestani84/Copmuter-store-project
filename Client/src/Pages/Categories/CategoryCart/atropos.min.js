...
var Atropos = (function () {
  ...
  return function (n) {
    ...
    var X,
      Y = function (t, e) {
        b.push({ element: t, prop: "transitionDuration", value: e });
      },
      _ = function (t, e) {
        b.push({ element: t, prop: "transitionTimingFunction", value: e });
      },
      L = function (t, e) {
        b.push({ element: t, prop: "transform", value: e });
      },
      T = function (t, e) {
        b.push({ element: t, prop: "opacity", value: e });
      },
      A = function (t, e, o, a) {
      ...
      R = function (t) {
        ...
        })(r, "[data-atropos-offset], [data-atropos-opacity]").forEach(
          function (t) {
            Y(t, i), _(t, c ? "ease-out" : "");
            var e = (function (t) {
              if (
            ...
            if (0 === o && 0 === n)
              s || L(t, "translate3d(0, 0, 0)"), e && T(t, e[0]);
            else {
              var a = parseFloat(t.dataset.atroposOffset) / 100;
              if (
                (Number.isNaN(a) ||
                  s ||
                  L(t, "translate3d(" + -n * -a + "%, " + o * -a + "%, 0)"),
                e)
              ) {
                var r = e[0],
                  p = e[1],
      ...
      I = function (t, e) {
        ...
        var N,
          S,
          k = (r / w.rotateXMax) * 100,
          q = (s / w.rotateYMax) * 100,
          B = (o ? (q / 100) * w.stretchX : 0) * (w.rotateYInvert ? -1 : 1),
          Z = (o ? (k / 100) * w.stretchY : 0) * (w.rotateXInvert ? -1 : 1),
          z = o ? (Math.max(Math.abs(k), Math.abs(q)) / 100) * w.stretchZ : 0;
        L(
          i,
          "translate3d(" +
            B +
          ...
          n &&
            ...
            ((N = i),
            (S = n),
            b.push({ element: N, prop: "transformOrigin", value: S })),
          d &&
            (Y(d, w.duration + "ms"),
            _(d, "ease-out"),
            L(d, "translate3d(" + 0.25 * -q + "%, " + 0.25 * k + "%, 0)"),
      ...
      P = function () {
        b.push(function () {
          ...
          Y(s, w.duration + "ms"),
          _(s, "ease-out"),
          l && (Y(l, w.duration + "ms"), _(l, "ease-out")),
          (O.isActive = !0);
      },
      j = function (t) {
        if (
          ...
          if (
            ...
            return (p = void 0), void (u = void 0);
          P(), "function" == typeof w.onEnter && w.onEnter();
        }
      },
      C = function (t) {
    ...
    return (
      ...
      g &&
        ...
        w.highlight &&
          (function () {
            var t;
            (d = e(g, ".atropos-highlight")) ||
              ((d = document.createElement("span")).classList.add(
                "atropos-highlight"
              ),
              (t = !0)),
              L(d, "translate3d(0,0,0)"),
        ...
        w.rotateTouch &&
          ("string" == typeof w.rotateTouch
            ? g.classList.add("atropos-rotate-touch-" + w.rotateTouch)
            : g.classList.add("atropos-rotate-touch")),
        e(r, "[data-atropos-opacity]") && R({ opacityOnly: !0 }),
        A(document, "click", N),
        A(M, "pointerdown", j),
        A(M, "pointerenter", j),
        A(M, "pointermove", D),
